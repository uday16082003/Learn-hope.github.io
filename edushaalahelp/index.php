...
<body>
    <header class="primary-header">
        <nav class="navbar container">
			<img id="icon" src="hopelogo.png" alt="Logo" style="width:190px; height:90px; margin-right:4px;">
            <a href="#" class="logo">Learn HOPE</a>
            <ul class="nav-list">
                <li>
    ...
    <section class="demo-content" style=" margin-top: 80px; background-color: #f5f5f5;" id="demo">
        ...
        <div id="container1" data-aos="fade-right" data-aos-easing="linear" data-aos-duration="3000">
            ...
            <div class="product-details">
                ...
                <p class="information">"Investing in education today, for a better tomorrow"
                </p>
        ...
        <div id="container3" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="2000">
            ...
            <div class="product-details">
                ...
                <!-- The most important information about the product -->
                <p class="information">"Empowering Minds, Building Futures: Join our college NGO today!"
                </p>
            ...
            <section class="counters">
                <div class="container1">
                    <div>
                        ...
                        <div class="counter" data-target="00">0</div>
                        <h3>Registered NGO's</h3>
                    </div>
                    <div>
                        <i class="fab fa-twitter fa-4x"></i>
                        <div class="counter" data-target="01">0</div>
                        <h3>Registered Communities</h3>
                    </div>
                    <div>
                        <i class="fab fa-facebook fa-4x"></i>
                        <div class="counter" data-target="03">0</div>
                        <h3>Our team </h3>
                    </div>
                </div>
        </div>
...
<section id="footer">
    <div class="main-footer">
      <div class="logoinfo" data-aos="fade-up">
        ...
        <div class="contact-details">
          <h1>Contact Us</h1>
          <li>
            <div class="fa fa-phone"></div><a href="tel:+91 9560653154, 7042829781, 8700141041, " style="color: black">+91 9560653154, 7042829781, 8700141041</a></li>
          <li>
            <div class="fa fa-envelope"></div><a href="mailto:learnhopehelp@gmail.com" style="color: black">learnhopehelp@gmail.com</a></li>
          </li>
      </div>
    </div>
    <div class="com " data-aos="fade-up">
      <h1>Contact us</h1>
      <ul>
        <li><a href="https://instagram.com/learnhope.pvt?igshid=YmMyMTA2M2Y=" style="color: black">Instagram</a></li>
        <li><a href="https://www.linkedin.com/in/learn-hope-64617b270/" style="color: black">LinkedIn</a></li>
        <li><a href="#" style="color: black">Youtube</a></li>
      </ul>
    </div>
